        ...
        <div className="navbar-fixed">
            <div className="nav-container">
                ...
                <div className="nav-right">
                    <ul>
                        ...
                        <li><a className="nav-text nav-works" href="#page-works">MY WORK</a></li>
                        <li><a className="nav-text nav-about" href="#page-about">ABOUT</a></li>
                        <li><a className="nav-text nav-contact" href="#page-contact">CONTACT</a></li>
                    </ul>
            ...
            <div className={`md:hidden nav-menu-mobile bg-white ${active ? 'active' : ''}`}>
                <ul>
                    ...
                    <li><a className="nav-menu-text nav-menu-works" href="#page-works">MY WORK</a></li>
                    <li><a className="nav-menu-text nav-menu-about" href="#page-about">ABOUT</a></li>
                    <li><a className="nav-menu-text nav-menu-contact" href="#page-contact">CONTACT</a></li>
                </ul>
            </div>
        </div>
    );
